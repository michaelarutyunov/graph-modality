...
SAMPLE_IDS_PATH = Path("extraction/model_comparison/demographics_sample_ids.txt")
PROMPT_PATH = Path("extraction/prompts/demographics_v1.txt")
TAGGED_DIR = Path("data/tagged")
RESULTS_DIR = Path("extraction/model_comparison/demographics_results")
