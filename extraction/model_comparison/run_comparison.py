...
SAMPLE_IDS_PATH = Path("extraction/model_comparison/sample_ids.txt")
PROMPT_PATH = Path("extraction/prompts/v1.txt")
TAGGED_DIR = Path("data/tagged")
RESULTS_DIR = Path("extraction/model_comparison/results")
