...
canonicalised graphs to ``data/graphs/canonical/``.  Re-validates each
...
FREE_TEXT_DIR = Path("data/graphs/free_text")
CANONICAL_DIR = Path("data/graphs/canonical")
MAP_PATH = Path("canonicalisation/canonical_map.json")
