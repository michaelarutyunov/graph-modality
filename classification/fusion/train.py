...
trains any classifier from classification/fusion/models.py. The classifier
is the ONLY component that learns per-target — modality encoders are frozen.

Usage:
    from classification.fusion.train import Trainer
...
class TrainingConfig:
    ...
    ``classification/fusion/config.py``.
    """
...
class Trainer:
    ...
    Args:
        model: Any classifier from ``classification/fusion/models.py``.
